package com.ggwp.memberservice.oauth2.service;


import com.ggwp.memberservice.domain.Member;
import com.ggwp.memberservice.domain.SocialType;
import com.ggwp.memberservice.oauth2.CustomOAuth2User;
import com.ggwp.memberservice.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Member getMember(OAuthAttributes extractAttributes, SocialType socialType) {
        ...
        if(findMember == null) {
            return saveMember(extractAttributes, socialType);
        }
        return findMember;
    }

    private Member saveMember(OAuthAttributes extractAttributes, SocialType socialType) {
        Member createdMember = extractAttributes.toEntity(socialType, extractAttributes.getOauth2UserInfo());
